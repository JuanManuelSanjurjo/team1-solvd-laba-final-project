import { MenuItem, SelectProps as MuiSelectProps, Select as MuiSelect, FormControl, Box, Typography} from "@mui/material"
...
export default function Select ({options, label, required, name, placeholder,...props}: SelectProps ) {
return (
