...
export default function PaymentMethodOption({ icon: Icon, label, selected }: PaymentMethodOptionProps) {
  return (
    <Box display="flex" flexDirection="column"  borderRadius={"12px"} border="1px solid " height={"100px"} minWidth={"100px"} maxWidth={"200px"} padding={"24px"} gap="10px" 
